        ...
        <div className="grid grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src="https://content.jdmagicbox.com/v2/comp/chennai/i4/044pxx44.xx44.170912141742.i1i4/catalogue/gts-centre-for-wellness-anna-nagar-chennai-weight-loss-centres-3wa0mv9.jpg" alt="GTS Clinic" className="h-16 w-auto object-contain" />
            </Link>
